...
public class DohvatiNajnovije extends AsyncTask<String, Integer, Void> {
    ...
    private IDohvatiNajnovijeDone p;
    public DohvatiNajnovije(IDohvatiNajnovijeDone p) { this.p=p; }
            ...
            try {
                ...
                for (int j = 0; j < items.length(); j++) {
                    ...
                    try {
                        ...
                        urlSlika="https://vignette.wikia.nocookie.net/five-nights-at-tubbyland/images/a/a5/X.png/revision/latest?cb=20160216225020";
                    }
